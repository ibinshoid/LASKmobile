...
public class Basic extends Activity {
	...
	public static String AppPath = "rfo.LASKmobile";				// Set to the path name for application directories
	...
	public static int loadProgramFileToList(boolean isFullPath, String path, ArrayList<String> list) {
		...
		// Save running bas path after making it relative to rfo.LASKmobile/source
